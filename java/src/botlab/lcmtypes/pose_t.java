...
public final class pose_t implements lcm.lcm.LCMEncodable
{
    ...
    {
        if (classes.contains(botlab.lcmtypes.pose_t.class))
            return 0L;
 
        classes.add(botlab.lcmtypes.pose_t.class);
    ...
    public static botlab.lcmtypes.pose_t _decodeRecursiveFactory(DataInput ins) throws IOException
    {
        botlab.lcmtypes.pose_t o = new botlab.lcmtypes.pose_t();
    ...
    public botlab.lcmtypes.pose_t copy()
    {
        botlab.lcmtypes.pose_t outobj = new botlab.lcmtypes.pose_t();
